...
SDK_MAJOR_VERSION_ENV=$$(SDK_MAJOR_VERSION_ENV)
DEFINES += SDK_MAJOR_VERSION=$$(SDK_MAJOR_VERSION_ENV)
...
isEmpty(SDK_MAJOR_VERSION_ENV) {
	error("SDK_MAJOR_VERSION_ENV not set (e.g. set SDK_MAJOR_VERSION_ENV=27)")
}
