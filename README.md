...
This plugin has been tested across different versions of Harmony 24, 25 and 27 on both Windows and Mac. Pre-compiled binaries are available for Harmony 24.0.2, 25.1, 25.2, 27.0.0 on Windows (64-bit) and Mac (ARM64).
